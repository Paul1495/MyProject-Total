...
const colorPallettePieVNA = [
  "rgba(48, 190, 255, 0.65)",
  "rgba(255, 255, 255, 0.11)",
];
const colorPallettePieVNB = [
  "rgba(249, 232, 13, 0.65)",
  "rgba(255, 255, 255, 0.11)",
];
const colorPallettePieVNC = [
  "rgba(30, 204, 51, 0.65)",
  "rgba(255, 255, 255, 0.11)",
];
const colorPallettePieVND = [
  "rgba(255, 96, 96, 0.65)",
  "rgba(255, 255, 255, 0.11)",
];
...
$(() => {
  ...
  $("#chart2").dxChart({
    ...
    title: {
      text: "RMIV Factories Output In Last 30 Days",
      font: {
        color: colorText,
        family: fontFamily,
      },
  ...
  $("#chart").dxChart({
    ...
    // title: {
    //   text: "RMIV Factories Efficiency In Last 30 Days",
    //   font: {
    //     color: colorText,
    //     family: fontFamily,
    //   },
...
const dataWorkerVNA = [
  {
    name: "WORKER QUANTITY ON",
    area: 7000,
  },
  {
    name: "WORKER QUANTITY OFF",
    area: 3000,
  },
];

const dataQuantityVNA = [
  {
    name: "AVERAGE DAILY QUANTITY",
    area: 7000,
  },
  {
    name: "DAILY QUANTITY",
...
const dataTotalQuantityVNA = [
  {
    name: "YEAR TOTAL ACTUAL QUANTITY",
    area: 50000000,
  },
  {
    name: "YEAR TOTAL PLAN QUANTITY",
    area: 100000000,
  },
];
...
//Data PieChart VNA -- Begin
const workerVNA = $("#workerVNA")
  .dxPieChart({
    type: "doughnut",
    palette: colorPallettePieVNA,
    diameter: 0.55,
    title: {
      text: "STATUS WORKER",
      font: fontTitle,
    ...
    dataSource: dataWorkerVNA,
    series: seriesOptions,
  })
  .dxPieChart("instance");

const quantityVNA = $("#quantityVNA")
  .dxPieChart({
    type: "doughnut",
    palette: colorPallettePieVNA,
    diameter: 0.55,
    ...
    legend: legendSettings,
    dataSource: dataQuantityVNA,
    series: seriesOptions,
  })
  .dxPieChart("instance");

const totalQuantityVNA = $("#totalQuantityVNA")
  .dxPieChart({
    type: "doughnut",
    palette: colorPallettePieVNA,
    diameter: 0.55,
    ...
    legend: legendSettings,
    dataSource: dataTotalQuantityVNA,
    series: seriesOptions,
  })
  .dxPieChart("instance");
//Data PieChart VNA -- Finish

//Data PieChart VNA -- Begin
const workerVNE = $("#workerVNE")
  .dxPieChart({
    type: "doughnut",
    palette: colorPallettePieVNB,
    diameter: 0.55,
    title: {
      text: "STATUS WORKER",
      font: fontTitle,
...
const totalQuantityVNE = $("#totalQuantityVNE")
  .dxPieChart({
    type: "doughnut",
    palette: colorPallettePieVNB,
    diameter: 0.55,
...
//Data PieChart VNA -- Begin
const workerVNC = $("#workerVNC")
  .dxPieChart({
    type: "doughnut",
    palette: colorPallettePieVNC,
    diameter: 0.55,
    title: {
      text: "STATUS WORKER",
      font: fontTitle,
...
const totalQuantityVNC = $("#totalQuantityVNC")
  .dxPieChart({
    type: "doughnut",
    palette: colorPallettePieVNC,
    diameter: 0.55,
...
//Data PieChart VNA -- Begin
const workerVND = $("#workerVND")
  .dxPieChart({
    type: "doughnut",
    palette: colorPallettePieVND,
    diameter: 0.55,
    title: {
      text: "STATUS WORKER",
      font: fontTitle,
...
const totalQuantityVND = $("#totalQuantityVND")
  .dxPieChart({
    type: "doughnut",
    palette: colorPallettePieVND,
    diameter: 0.55,
