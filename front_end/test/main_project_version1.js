...
const workerVNA = 10000;
$("#yearTotalVNA").text(`YEAR QUANTITY: ${abbreviateNumber(dataYearTotalVNA)}`);
$("#yearTargetVNA").text(
  `YEAR TARGET QUANTITY: ${abbreviateNumber(dataYearTargetVNA)}`
);
$("#dailyQuantityVNA").text(
  `DAILY QUANTITY: ${abbreviateNumber(dailyQuantityVNA)}`
);
$("#quantityVNA").text(`QUANTITY:`);
$("#workerVNA").text(`WORKER QUANTITY: ${abbreviateNumber(workerVNA)}`);
$("#attendantVNA").text(`ATTENDANT:`);

const dataYearTotalVNE = 45500000;
const dataYearTargetVNE = 9120000000;
const dailyQuantityVNE = 75000;
const workerVNE = 20000;
$("#yearTotalVNE").text(`YEAR QUANTITY: ${abbreviateNumber(dataYearTotalVNE)}`);
$("#yearTargetVNE").text(
  `YEAR TARGET QUANTITY: ${abbreviateNumber(dataYearTargetVNE)}`
);
$("#dailyQuantityVNE").text(
  `DAILY QUANTITY: ${abbreviateNumber(dailyQuantityVNE)}`
);
$("#quantityVNE").text(`QUANTITY:`);
$("#workerVNE").text(`WORKER QUANTITY: ${abbreviateNumber(workerVNE)}`);
$("#attendantVNE").text(`ATTENDANT:`);

const dataYearTotalVNC = 56700000;
const dataYearTargetVNC = 12000000000;
const dailyQuantityVNC = 63000;
const workerVNC = 15000;
$("#yearTotalVNC").text(`YEAR QUANTITY: ${abbreviateNumber(dataYearTotalVNC)}`);
$("#yearTargetVNC").text(
  `YEAR TARGET QUANTITY: ${abbreviateNumber(dataYearTargetVNC)}`
);
$("#dailyQuantityVNC").text(
  `DAILY QUANTITY: ${abbreviateNumber(dailyQuantityVNC)}`
);
$("#quantityVNC").text(`QUANTITY:`);
$("#workerVNC").text(`WORKER QUANTITY: ${abbreviateNumber(workerVNC)}`);
$("#attendantVNC").text(`ATTENDANT:`);

const dataYearTotalVND = 50000000;
const dataYearTargetVND = 10000000000;
const dailyQuantityVND = 70000;
const workerVND = 10000;
$("#yearTotalVND").text(`YEAR QUANTITY: ${abbreviateNumber(dataYearTotalVND)}`);
$("#yearTargetVND").text(
  `YEAR TARGET QUANTITY: ${abbreviateNumber(dataYearTargetVND)}`
);
$("#dailyQuantityVND").text(
  `DAILY QUANTITY: ${abbreviateNumber(dailyQuantityVND)}`
);
$("#quantityVND").text(`QUANTITY:`);
$("#workerVND").text(`WORKER QUANTITY: ${abbreviateNumber(workerVND)}`);
$("#attendantVND").text(`ATTENDANT:`);
