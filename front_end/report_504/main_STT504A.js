import { data } from "../report_504/data_STT504A.js";
...
const columns_data = [
  ...
  },
  {
    ...
    calculateCellValue: (rowData) => {
      rowData["Efficiency"] =
        (rowData["Sam"] * rowData["KeyStage"]) / (rowData["Real"] * time);
      ...
      calculateCustomSummary(e) {
        if (e.name == "SelectedEfficencySummary") {
          if (e.summaryProcess == "start") {
            ...
            e.totalValue =
              Math.round(
                ((e.samTotal * e.keyStageTotal) / (e.realTotal * time) +
                  Number.EPSILON) *
                  10000
              ) / 10000;
          }
        ...
        if (e.name == "SelectedRateSummary") {
          if (e.summaryProcess == "start") {
            ...
            e.totalValue =
              Math.round(
                (e.keyStageTotal / e.targetTotal + Number.EPSILON) * 10000
              ) / 10000;
          }
        }
      },
